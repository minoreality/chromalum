...
export const en = {
  ...
  theory_conn_boundary:
    "Only S\u2083 (6 channel permutations) of GL(3,2) (order 168) preserves chromatic meaning. Complement \u03c3(v) = v \u2295 (1,1,1) is a translation in AG(3,2), not a linear map in GL(3,2) \u2014 it sends W\u21a6K, leaving PG(2,2). GF(8) multiplication and 12+ color extensions lie outside this framework.",
