...
export const ja = {
  ...
  theory_venn_desc:
    "3つのチャンネル {G,R,B} の部分集合は 2\u00b3 = 8 通り存在します。3つの円が作る8領域が、そのまま8色に対応します。外側は空集合 ∅ (Black)、3つの円が重なる中央部は全集合 {G,R,B} (White) です。各色は部分集合 A \u2286 {G,R,B} と一対一に対応し、特性関数 \u03c7_A(x)（チャンネル x について、x ∈ A なら 1、そうでなければ 0）として読めます。以下の全セクションは、この同じ8元集合を異なる角度から描いています。",
