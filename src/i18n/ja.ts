...
export const ja: Record<TranslationKey, string> = {
  ...
  theory_conn_cube_geometry_hook:
    "立方体の幾何: ファノ平面の7線は、Black を含む GF(2)^3 の 7 つの 2 次元部分空間に対応します。Euclid 的な立方体では、そのうち 6 つは実際の平面断面（3 つの座標平面と 3 つの対角平面）として現れ、残る CMY 線は偶数パリティ四面体 {0,3,5,6} に対応します。3 つのパリティ検査は G=0, R=0, B=0 の座標平面です。",
  ...
  theory_octa_desc:
    "6有彩色とその補色対称性を最も対称的に表す形です。各補色軸（R\u2194C, G\u2194M, B\u2194Y）が対頂点を結び、原色が + 軸、CMY が \u2212 軸に配置されます。色立方体の双対であり、6 頂点は 8 面（各 GF(2)^3 元）に対応し、面隣接グラフは立方体グラフそのものです。八面体の 12 辺は 6 つの有彩色 XOR 結果を各 2 回ずつ与え、各非補色ペア {a,b} には離散的な第三の色 a\u2295b が定まります。",
  ...
  music_octa_title: "カラーダイヤ",
  music_octa_play: "\u25b6 八面体",
  music_octa_hint_invalid: "非補色ペアを選択",
  music_tetra_title: "T0/T1 分割",
