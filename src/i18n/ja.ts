...
export const ja: Record<TranslationKey, string> = {
  ...
  theory_venn_desc:
    "チャンネル3元集合 {G, R, B} の部分集合は 2\u00b3 = 8 通り。3円が作る8領域が、そのまま8色に対応します。外側が空集合 \u2205 (Black)、中心の三重重なりが全集合 {G, R, B} (White) です。各色は特性関数 \u03c7_A: {G,R,B} \u2192 {0,1} として読め、以下の全セクションは、この同じ8元集合を異なる角度から描いています。",
  ...
  theory_cube_desc2:
    "「ハッセ図」ボタンで、同じ立方体を体対角線方向から眺めた射影に切り替わります（位相的には同一の Q\u2083 グラフ）。K を下端、W を上端とし、rank = |A|（色が含むチャンネル数）で 4 層に分かれます \u2014 Pascal 三角形 1, 3, 3, 1 が直接読めます。原子（rank 1 = RGB 原色）と余原子（rank 2 = CMY）は補写像で対応し、これが補色対の代数的起源です。12 辺は G・R・B チャンネルごとの 3 つの完全マッチングに分解されます。上向きに辿れば加法混色、下向きなら減法混色 \u2014 ハッセ図の自己双対性がこの加減法の等価性を与えています。",
