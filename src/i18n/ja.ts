...
export const ja = {
  ...
  about_body_2:
    "まずはSourceタブで絵を描くか、画像を読み込むところから始めます。HexタブやColorタブで八段階の明るさに色を割り当て、配色を決めます。その組み合わせの全パターンはGalleryタブで参照できます。Glazeタブでは別の候補色をオーバーレイすることができます。キャンバスの情報の分析にはMapタブを使います。",
  ...
  theory_binary_tone_complement: "補色トーン定理: T\u2096 + T\u2087\u208b\u2096 = 1（8ビット表示では 255）",
