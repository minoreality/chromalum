...
export const ja = {
  ...
  theory_intro:
    "CHROMALUMでは、RGB 各チャンネルを 0 または 1 の状態として扱う 8 頂点を、3 ビットベクトル `[G,R,B]` として符号化します。各ビットは Green, Red, Blue のオン/オフを表し、この8つのベクトルが8色に対応します。\n\nこの8点集合は、GF(2) 上の3次元ベクトル空間 GF(2)³ として読めます。GF(2) は 0 と 1 だけから成る最小の有限体であり、1+1=0 が成り立つため、ベクトルの加法はビットごとの XOR になります。\n\n8点全体はカラーキューブ、6 つの有彩色はグレイコード巡回、非零7点はファノ平面、同じ7点はハミング符号の位置ラベルとして読めます。Theoryタブでは、これらを同じ8色モデルの複数の読み方として、代数的色彩体系に統合します。",
