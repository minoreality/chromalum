...
export const ja: Record<TranslationKey, string> = {
  ...
  theory_venn_desc:
    "3つのチャンネル {G,R,B} の部分集合は 2\u00b3 = 8 通り。3つの円が作る8領域が、そのまま8色に対応します。外側が空集合 \u2205 (Black)、中心の三重重なりが全集合 {G,R,B} (White) です。各色は部分集合 A \u2286 {G,R,B} と等価で、特性関数 \u03c7_A: {G,R,B} \u2192 {0,1} として読めます。以下の全セクションは、この同じ8元集合を異なる角度から描いています。",
  ...
  theory_dice_desc:
    "BT.601 luma で6つの有彩色 RGB 頂点を暗い順に1\u20136とナンバリングし、六面体の面に配置します。補色写像 c \u21a6 c xor 7 はルマ順を反転するため、補色ペアは対面に位置し、どの対面の和も7 \u2014 標準的なサイコロの規則と同一です。",
  theory_dice_desc2:
