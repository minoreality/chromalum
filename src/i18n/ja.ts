...
export const ja: Record<TranslationKey, string> = {
  ...
  theory_binary_desc:
    "各レベルは3ビット数値です。ビットとチャンネルの割り当て6通りのうち、レベル番号がルマ値に対して単調増加するのは GRB（ビット2=Green, ビット1=Red, ビット0=Blue）だけです。これは Green のルマ係数が Red+Blue を超え、かつ Red が Blue を超えるためです（0.587 > 0.299 + 0.114, 0.299 > 0.114）。任意の設計ではなく、人間の色覚の帰結です。原色の番号 {1, 2, 4} は、元・ペア和・全体和（いずれも通常の整数加算）が {1, \u2026, 7} を重複なく生成する唯一の3元集合です。",
