...
const CIRCLES = [
  { channel: "R", bit: 2, center: R_CENTER, color: CHROMALUM_CHANNEL_HEX.R },
  { channel: "G", bit: 4, center: G_CENTER, color: CHROMALUM_CHANNEL_HEX.G },
  { channel: "B", bit: 1, center: B_CENTER, color: CHROMALUM_CHANNEL_HEX.B },
] as const;
