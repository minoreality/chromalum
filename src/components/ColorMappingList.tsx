          ...
          return (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                gap: SP.md,
                padding: `${has ? 0 : SP.md}px ${SP.lg}px`,
            ...
            >
              ...
              />
              <span style={{ fontSize: FS.md, color: C.textDimmer, width: 44 }}>
                L{i} {info.name.slice(0, 3)}
              </span>
              {has && (
                <button
              ...
              {cur.hueLabel && <span style={{ fontSize: FS.xxs, color: C.textDimmer, marginLeft: SP.xs }}>{cur.hueLabel}</span>}
              {has && (
